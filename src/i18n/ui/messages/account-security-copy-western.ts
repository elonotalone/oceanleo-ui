...
export const ACCOUNT_SECURITY_COPY_WESTERN = {
  en: {
    ...
    dailyLimitNow: "Currently {amount} per day.",
  ...
  de: {
    ...
    dailyLimitNow: "Aktuell {amount} pro Tag.",
  ...
  es: {
    ...
    dailyLimitNow: "Ahora son {amount} al día.",
  ...
  fr: {
    ...
    dailyLimitNow: "Actuellement {amount} par jour.",
  ...
  it: {
    ...
    dailyLimitNow: "Adesso è {amount} al giorno.",
    spentToday: "Speso oggi: {amount}.",
  ...
  "pt-BR": {
    ...
    dailyLimitNow: "Agora são {amount} por dia.",
    spentToday: "Gasto hoje: {amount}.",
  ...
  vi: {
    ...
    dailyLimitNow: "Hiện là {amount} mỗi ngày.",
    spentToday: "Hôm nay đã tiêu {amount}.",
  ...
  tr: {
    ...
    dailyLimitNow: "Şu anda günde {amount}.",
    spentToday: "Bugün harcanan: {amount}.",

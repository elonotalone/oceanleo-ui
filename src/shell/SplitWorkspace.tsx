...
function PaneHeader({ label, children }: { label?: ReactNode; children?: ReactNode }) {
  ...
  return (
    <div
      ...
      className="relative z-40 flex min-h-[2.5rem] min-w-0 shrink-0 flex-nowrap items-center justify-between gap-1 overflow-hidden border-b border-stone-100 px-3 py-1.5"
    >
      {isPlain ? (

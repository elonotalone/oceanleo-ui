...
>(function EditorToolsTrigger(
  ...
  return (
    <button
      ...
      className={`grid h-11 w-11 shrink-0 place-items-center rounded-xl outline-none transition focus-visible:ring-2 focus-visible:ring-[var(--awb-accent,#7c3aed)]/40 ${
        available
          ? "hover:brightness-95"

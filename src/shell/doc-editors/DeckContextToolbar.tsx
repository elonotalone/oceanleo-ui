  ...
  const context = useMemo<SelectionContext>(() => {
    if (!element) {
      return {
        ...
        controls: [
          ...
          { id: "title", kind: "text", label: tt("标题"), value: slide.title },
          { id: "body", kind: "text", label: tt("正文"), value: slide.body },
          {
            id: "background",
            kind: "color",
            label: tt("背景"),
    ...
    return {
      ...
      controls: [
        ...
        { id: "layer-up", kind: "action", label: tt("上移一层"), placement: "more" },
        { id: "layer-down", kind: "action", label: tt("下移一层"), placement: "more" },

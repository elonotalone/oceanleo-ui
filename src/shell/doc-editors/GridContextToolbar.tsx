  ...
  const context = useMemo<SelectionContext>(
    () => ({
      ...
      controls: [
        ...
        { id: "row-before", kind: "action", label: tt("上方插入行"), icon: "plus", group: "row", placement: "more" },
        { id: "row-after", kind: "action", label: tt("下方插入行"), icon: "plus", group: "row", placement: "more" },
        {
          id: "row-delete",
          kind: "action",
          label: tt("删除所选行"),
        ...
        { id: "column-before", kind: "action", label: tt("左侧插入列"), icon: "plus", group: "column", placement: "more" },
        { id: "column-after", kind: "action", label: tt("右侧插入列"), icon: "plus", group: "column", placement: "more" },
        {
          id: "column-delete",
          kind: "action",
          label: tt("删除所选列"),
        ...
        { id: "sort-asc", kind: "action", label: tt("升序"), icon: "layer-up", group: "sort", placement: "more" },
        { id: "sort-desc", kind: "action", label: tt("降序"), icon: "layer-down", group: "sort", placement: "more" },
      ],
    }),
